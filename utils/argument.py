...
#datadir
parser.add_argument("--dataset", type=str, default="cifar10", choices=["image-cars", "cifar10", "cifar100", "stl10", "ppmi", "stanford-40-actions"])
...
if args.dataset == "cifar10":
    ...
    args.num_classes = 20
elif args.dataset == "image-cars":
    args.image_folder += "image-cars/"
    args.num_classes = 20
